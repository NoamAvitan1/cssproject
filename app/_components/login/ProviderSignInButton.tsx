  ...
  return (
    <div className="flex flex-col justify-between items-center h-[100px] w-full">
      <button
        ...
        className="flex justify-between w-full items-center font-serif text-text border border-slate-400 p-2 px-6 rounded shadow-sm hover:ring-[4px] ring-aura ring-opacity-20 duration-150">
