...
export const Teller = (props: Props) => {
  ...
  return (
    <article
      className="container fixed left-1/2 z-50 mt-1 flex max-w-[800px] -translate-x-1/2 flex-col justify-start gap-2 overflow-x-hidden"
      style={{
        height: 3.5 * tales.length + "rem",
      }}
    >
      {tales.map((tale, i) => (
        <div
