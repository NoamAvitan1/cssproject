...
export const Module = ({ index, module, enableEdit }: Props) => {
  ...
  return (
    <section
      key={index}
      className="rounded-[0.43rem] max-w-[350px] lg:max-w-[400px] bg-gradient-to-b from-violet-500 to-sky-500 p-[1px]"
    >
            ...
            >
              {module?.user_id?.profile_pic && (
                <img
                  ...
                  className="max-h-[20px] max-w-[20px] rounded-full mr-[2px]"
                  alt=""
                />
              )}
